...
function Contact() {
    return (
        <div className="col-start-1 row-start-4 col-span-1 row-span-2
            ...
            <div className="space-y-1 pl-1.5 ml-2 mt-4">
                <Input className="mb-4 max-w-[18vw]" type="email" placeholder="Your Name" />
                <Input className="mb-4 max-w-[18vw]" type="email" placeholder="Your Email" />
                <Textarea className="mb-4 max-w-[18vw]" placeholder="Type your message here." />
